...
function url_redirect($values = []) {
    ...
    header('Location: '.PAGE_URL.'?'.$buildQueryString); // a função "header" modifica o cabeçalho de um pedido/resposta do servidor, neste caso, é responder com um redirecionamento. https://www.php.net/manual/en/function.header
